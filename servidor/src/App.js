...
require('./routes/empadronamiento')(app);
require('./routes/empadronamientodetalles')(app);
require('./routes/empadronamientoactividadesporsocio')(app);
require('./routes/localidades')(app);
